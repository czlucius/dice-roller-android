...
public class DiceFragmentBindingImpl extends DiceFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.diceCanvas, 1);
        sViewsWithIds.put(R.id.bottomApp, 2);
        sViewsWithIds.put(R.id.diceNum, 3);
        sViewsWithIds.put(R.id.fabRoll, 4);
        sViewsWithIds.put(R.id.remove_area, 5);
