package com.czluciusdev.diceroller.databinding;
import com.czluciusdev.diceroller.R;
import com.czluciusdev.diceroller.BR;
...
public class DiceFragmentBindingImpl extends DiceFragmentBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((com.czluciusdev.diceroller.DiceViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable com.czluciusdev.diceroller.DiceViewModel Vm) {
        this.mVm = Vm;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.czluciusdev.diceroller.DiceViewModel vm = mVm;
